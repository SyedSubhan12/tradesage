...
import { ChevronRight, Bot, LineChart, PieChart, BarChart, Shield, Zap } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#030303] overflow-hidden">
      {/* Navbar */}
      <DynamicNavbar 
        className="fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-white/5 backdrop-blur-sm"
        onChange={(index) => {
          if (index === null) return;
          const titles = ['Home', 'Features', 'Pricing', 'Contact'];
      ...
      {/* Contact Section */}
      <section id="contact" className="relative z-10 py-20 bg-[#0a0a0a]/90 backdrop-blur-md overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <motion.div
              initial={{ opacity: 0 }}
          ...
          <form className="max-w-3xl mx-auto grid grid-cols-1 gap-6">
            <input type="text" placeholder="Name" className="px-4 py-3 rounded-md bg-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-plasma-purple" />
            <input type="email" placeholder="Email" className="px-4 py-3 rounded-md bg-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-plasma-purple" />
            <textarea placeholder="Message" rows={5} className="px-4 py-3 rounded-md bg-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-plasma-purple" />
            <Button className="bg-plasma-purple hover:bg-plasma-purple/90 text-white rounded-full px-6 py-3">
              Send Message
            </Button>
          </form>
        </div>
